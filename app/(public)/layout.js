...
export default async function PublicLayout({children}) {
  ...
  return <div className="store-theme" data-button-style={settings.theme_button_style || 'solid'} style={themeStyle(settings)}>{children}<ScrollToTopButton /><AnalyticsTracker /></div>;
}
